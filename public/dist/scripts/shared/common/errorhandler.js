...
angular.module('fantumn.errorHandler', [])
    .constant('httpErrors', {
        ...
        500: 'Sorry, Unknown errors at the server.',
        401: 'Sorry, The authorization is failed'
    })
    .provider('errorHandler', function() {
        ...
        // The actual service:
        return {
            // Decorate the mentioned [services] with automatic error handling. See sample.js for an example.
